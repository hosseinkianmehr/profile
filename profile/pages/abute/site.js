        ...
        <>
            <Grid container>
                ...
                <Grid xs={12} sm={6} md={6} item>
                    <Image src={'/svg/abute/undraw_feeling_proud_qne1.svg'} width={400} height={400} />
                </Grid>
                ...
                {/* 2 */}
                {
                    ...
                    isTinyScreen ?
                        <>
                            ...
                            <Grid xs={12} sm={6} md={6} item>
                                <Image src={'/svg/abute/undraw_static_assets_rpm6.svg'} width={400} height={400} />
                            </Grid>
                        </>
                        :
                        <>
                ...
                {/* 3 */}
                <Grid xs={12} sm={6} md={6} item>
                    <Image src={'/svg/abute/undraw_visionary_technology_re_jfp7.svg'} width={400} height={400} />
                </Grid>
                <Grid xs={12} sm={6} md={6} item style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <Box style={{ maxWidth: 300 }}>
